...
const LOVE_REASONS = [
  ...
  "Because you are not just my love, you are my best friend and soulmate forever ❤️"
];
...
export const LoveReasonsModal: React.FC<LoveReasonsModalProps> = ({ isOpen, onClose, recipientName }) => {
